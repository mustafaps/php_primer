...
<body>
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item"><a class="nav-link" href="forloop.php">forloop</a></li>
        <li class="nav-item"><a class="nav-link" href="switchstatement.php">Simple switch Statement</a></li>
        <li class="nav-item"><a class="nav-link" href="dowhileloop.php">Do While</a></li>
        <li class="nav-item"><a class="nav-link" href="arrays.php">Arrays</a></li>
        <li class="nav-item"><a class="nav-link" href="stringsman.php">Strings Manipulation</a></li>
